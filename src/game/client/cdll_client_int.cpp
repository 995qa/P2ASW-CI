...
#include "cbase.h"
#include <stdio.h> // Include the necessary header for file operations
#include <string>
...
#ifdef P2ASW
	// These were renamed in Portal 2, update them to new values when the game resolution changes.
